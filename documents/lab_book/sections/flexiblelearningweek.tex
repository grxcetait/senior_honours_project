...
\begin{itemize}
    ...
    \item I think the issue with "optimize.fmin" was that there was no way to set bounds to the optimisation so the parameter values were going out of range of what could work.
    \item I tried some more optimisation techniques within the "optimize.minimize" function such as: L-BFGS-B, SLSQP, TNC, Powell. 
    \item These techniques either were not successful or they were successful but gave results that were similar to what I tried yesterday, with similar log-marginal likelihoods.
\end{itemize}

\newpage

\subsubsection{Plots from initial guesses}

\begin{figure}[htb!]
    \centering
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{outputs/week8/hi_signal_kernal_comparison_inital_guesses.pdf}
        \label{fig:pspec_lin_0_01}
    \end{minipage}
    \hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{outputs/week8/fg_signal_kernal_comparison_inital_guesses.pdf}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.4\linewidth]{outputs/week8/log_1d_power_spectrum_inital_guesses.pdf}
    \caption{Enter Caption}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.9\linewidth]{outputs/week8/cylindrical_power_spectrum_inital_guesses.pdf}
    \caption{Enter Caption}
    \label{fig:placeholder}
\end{figure}
...
\subsubsection{Scipy optimize minimize, Nelder-Mead, RBF kernel with spectral index}

\begin{figure}[htb!]
    \centering
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{outputs/week8/hi_signal_kernal_comparison_nelder_mead.pdf}
        \label{fig:pspec_lin_0_01}
    \end{minipage}
    \hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{outputs/week8/fg_signal_kernal_comparison_nelder_mead.pdf}
        \label{fig:pspec_log_0_01}
    \end{minipage}
    \caption{Enter Caption}
\end{figure}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.4\linewidth]{outputs/week8/log_1d_power_spectrum_nelder_mead.pdf}
    \caption{Enter Caption}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.9\linewidth]{outputs/week8/cylindrical_power_spectrum_nelder_mead.pdf}
    \caption{Enter Caption}
    \label{fig:placeholder}
\end{figure}