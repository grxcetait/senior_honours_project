...
\begin{figure}[htb!]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{outputs/week3/hydrogen_map_w_foreground.pdf}
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{outputs/week3/hydrogen_map_wo_foreground.pdf}
